...
// Compiler Info: C++
// Purpose: We have to find the correlation coefficient between two arrays 
// (Confirmed cases and confirmed ICU) to see the strength of the association between Confirmed cases and confirmed ICU numbers. 
// The magnitude of the correlation coefficient indicates the strength of the association.
// This C++ program displays this coorelation coefficient along with a conclusion of it in a UI after gathering the data from a text file.
// This data shows two columns(Confirmed cases and confirmed ICU) and is taken from https://ourworldindata.org/.
//-------------------------------------------------------------------
